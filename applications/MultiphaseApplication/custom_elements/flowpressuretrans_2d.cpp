...
namespace Kratos
{
	...
	void FlowPressureTrans2D::GetDofList(DofsVectorType& rElementalDofList, ProcessInfo& rCurrentProcessInfo)
	{
		...
		default:
		{
			KRATOS_THROW_ERROR(std::logic_error,"Unexpected value for FRACTIONAL_STEP index at the flowpressuretrans_2d element: ",rCurrentProcessInfo[FRACTIONAL_STEP]);
		}
		}
	...
	{
		KRATOS_THROW_ERROR(std::logic_error,  "method not implemented at the flowpressuretrans_2d element" , "");
	}	 
        //************************************************************************************
	//************************************************************************************
	...
	void FlowPressureTrans2D::InitializeSolutionStep(ProcessInfo& CurrentProcessInfo)
	{
        ...
        */
        ...
        void FlowPressureTrans2D::CalculateDensityElement()
        {
            ...
            this->GetValue(b/*DENSITY_ELEM) = densityElement;
             */
